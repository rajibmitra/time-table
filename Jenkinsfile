node('mac') {
    ...
    stage('Checkout/Build/Test') {
        ...
        // Build and Test
        sh 'xcodebuild -scheme "TimeTable" -configuration "Debug" build test -destination "platform=iOS Simulator,OS=11.1, name=iPhone 6" -enableCodeCoverage YES | /usr/local/bin/xcpretty -r junit'
